...
namespace LibRSA {
    ...
    public class RSAProvider {
        ...
        public string Encrypt(string message, string publicKey = "<RSAKeyValue><Modulus>21wEnTU+mcD2w0Lfo1Gv4rtcSWsQJQTNa6gio05AOkV/Er9w3Y13Ddo5wGtjJ19402S71HUeN0vbKILLJdRSES5MHSdJPSVrOqdrll/vLXxDxWs/U0UT1c8u6k/Ogx9hTtZxYwoeYqdhDblof3E75d9n2F0Zvf6iTb4cI7j6fMs=</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>") {
        ...
        public string Decrypt(string cyper) {
            string decryptedData;
            using ( var rsa = new RSACryptoServiceProvider(1024) ) {
                rsa.FromXmlString(this.PrivateKey);
                var resultBytes = Convert.FromBase64String(cyper);
